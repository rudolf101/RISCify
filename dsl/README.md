...
To create instances of instructions, follow the example below
```
const addInstruction = new Add();
addInstruction.parse(0x00F50733);

const addiInstruction = new Addi();
addiInstruction.parse(0x01350613);
```